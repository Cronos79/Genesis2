...
void GenGameObject3d::SetLookAtPos(XMFLOAT3 lookAtPos)
{
...
const XMVECTOR& GenGameObject3d::GetForwardVector(bool omitY)
{
	if (omitY)
...
const XMVECTOR& GenGameObject3d::GetRightVector(bool omitY)
{
	if (omitY)
...
const XMVECTOR& GenGameObject3d::GetBackwardVector(bool omitY)
{
	if (omitY)
...
const XMVECTOR& GenGameObject3d::GetLeftVector(bool omitY)
{
	if (omitY)
		return vec_left_noY;
	else
...
void GenGameObject3d::UpdateMatrix()
{
	assert("UpdateMatrix must be overridden." && 0);
}

void GenGameObject3d::UpdateDirectionVectors()
{
